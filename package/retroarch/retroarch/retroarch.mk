...
ifeq ($(BR2_PACKAGE_HAS_LIBMALI),y)
  ifneq ($(BR2_PACKAGE_KNULLI_TARGET_RK3568),y)
    ifneq ($(BR2_PACKAGE_KNULLI_TARGET_RK3326),y)
	RETROARCH_CONF_OPTS += --enable-mali_fbdev
    endif
  endif
endif

ifeq ($(BR2_PACKAGE_KNULLI_TARGET_ATM7039)$(BR2_PACKAGE_KNULLI_TARGET_SUNXI_R16),y)
...
define RETROARCH_EVMAPY
	...
	cp -f $(BR2_EXTERNAL_KNULLI_PATH)/package/retroarch/retroarch/libretro.keys \
...
ifeq ($(BR2_PACKAGE_KNULLI_TARGET_BCM2836),y)
...
ifeq ($(BR2_PACKAGE_KNULLI_TARGET_BCM2711),y)
    LIBRETRO_PLATFORM += rpi4_64
endif

ifeq ($(BR2_PACKAGE_KNULLI_TARGET_BCM2712),y)
