...
_AZAHAR_BIN: Final = Path("/usr/bin/azahar")
_AZAHAR_CFG_DIR: Final = CONFIGS / "azaharplus-emu"
_AZAHAR_CFG_FILE: Final = _AZAHAR_CFG_DIR / "qt-config.ini"
_AZAHAR_DATA_DIR: Final = SAVES / "3ds"
...
class AzaharGenerator(Generator):
    ...
    def generate(self, system, rom, playersControllers, metadata, guns, wheels, gameResolution):
        ...
        return Command.Command(array=commandArray, env={
            ...
            "XDG_DATA_HOME": str(_AZAHAR_DATA_DIR),
            "XDG_CACHE_HOME": str(CACHE),
            "AZAHAR_QT_CONFIG_DIR": str(_AZAHAR_CFG_DIR),
            "QT_QPA_PLATFORM": "xcb",
