...
ifeq ($(BR2_PACKAGE_KNULLI_TARGET_BCM2835),y)
	KNULLI_CONFIGGEN_SYSTEM=bcm2835
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_BCM2836),y)
	KNULLI_CONFIGGEN_SYSTEM=bcm2836
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_BCM2837),y)
	KNULLI_CONFIGGEN_SYSTEM=bcm2837
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_BCM2711),y)
	KNULLI_CONFIGGEN_SYSTEM=bcm2711
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_BCM2712),y)
	KNULLI_CONFIGGEN_SYSTEM=bcm2712
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_XU4),y)
	KNULLI_CONFIGGEN_SYSTEM=odroidxu4
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_RK3288),y)
	KNULLI_CONFIGGEN_SYSTEM=rk3288
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_S905),y)
	KNULLI_CONFIGGEN_SYSTEM=s905
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_S905GEN2),y)
	KNULLI_CONFIGGEN_SYSTEM=s905gen2
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_S905GEN3),y)
	KNULLI_CONFIGGEN_SYSTEM=s905gen3
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_S9GEN4),y)
	KNULLI_CONFIGGEN_SYSTEM=s9gen4
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_X86),y)
	KNULLI_CONFIGGEN_SYSTEM=x86
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_X86_64_ANY),y)
	KNULLI_CONFIGGEN_SYSTEM=x86_64
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_RK3399),y)
	KNULLI_CONFIGGEN_SYSTEM=rk3399
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_S922X),y)
	KNULLI_CONFIGGEN_SYSTEM=s922x
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_A3GEN2),y)
	KNULLI_CONFIGGEN_SYSTEM=a3gen2
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_RK3328),y)
	KNULLI_CONFIGGEN_SYSTEM=rk3328
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_RK3568),y)
	KNULLI_CONFIGGEN_SYSTEM=rk3568
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_RK3326),y)
	KNULLI_CONFIGGEN_SYSTEM=rk3326
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_H3),y)
	KNULLI_CONFIGGEN_SYSTEM=h3
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_H5),y)
	KNULLI_CONFIGGEN_SYSTEM=h5
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_H616),y)
	KNULLI_CONFIGGEN_SYSTEM=h616
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_H700),y)
	KNULLI_CONFIGGEN_SYSTEM=h700
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_A133),y)
	KNULLI_CONFIGGEN_SYSTEM=a133
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_T527),y)
	KNULLI_CONFIGGEN_SYSTEM=t527
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_SUNXI_R16),y)
	KNULLI_CONFIGGEN_SYSTEM=r16
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_ATM7039),y)
	KNULLI_CONFIGGEN_SYSTEM=atm7039
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_S812),y)
	KNULLI_CONFIGGEN_SYSTEM=s812
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_RK3128),y)
	KNULLI_CONFIGGEN_SYSTEM=rk3128
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_ODIN),y)
	KNULLI_CONFIGGEN_SYSTEM=odin
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_H6),y)
	KNULLI_CONFIGGEN_SYSTEM=h6
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_RK3588),y)
	KNULLI_CONFIGGEN_SYSTEM=rk3588
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_RISCV),y)
	KNULLI_CONFIGGEN_SYSTEM=riscv
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_SM8250),y)
...
ifeq ($(BR2_PACKAGE_KNULLI_TARGET_X86_64_ANY),y)
