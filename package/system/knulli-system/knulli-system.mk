...
ifeq ($(BR2_PACKAGE_KNULLI_TARGET_BCM2837),y)
...
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_X86_64),y)
	KNULLI_SYSTEM_ARCH=x86_64
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_STEAMDECK),y)
	KNULLI_SYSTEM_ARCH=steamdeck
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_ZEN3),y)
	KNULLI_SYSTEM_ARCH=x86-64-v3
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_BCM2836),y)
	KNULLI_SYSTEM_ARCH=bcm2836
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_BCM2835),y)
