...
ifeq ($(BR2_PACKAGE_KNULLI_SPLASH_MPV),y)
    ...
    else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_AMLOGIC_ANY)$(BR2_PACKAGE_KNULLI_RPI_ANY)$(BR2_PACKAGE_KNULLI_TARGET_RK3399)$(BR2_PACKAGE_KNULLI_TARGET_H6)$(BR2_PACKAGE_KNULLI_TARGET_H616),y)
...
ifeq ($(KNULLI_SPLASH_MEDIA),video)
    ...
    ifeq ($(BR2_PACKAGE_KNULLI_TARGET_H3),y)
        KNULLI_SPLASH_POST_INSTALL_TARGET_HOOKS += KNULLI_SPLASH_INSTALL_VIDEO_CAPCOM
    endif

    # alternative video
    ifeq ($(BR2_PACKAGE_KNULLI_RPI_ANY)$(BR2_PACKAGE_KNULLI_TARGET_RK3326)$(BR2_PACKAGE_KNULLI_TARGET_RK3128)$(BR2_PACKAGE_KNULLI_TARGET_H3),y)
