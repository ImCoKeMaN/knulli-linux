...
# Keyed on the wayland library, not BATOCERA_WAYLAND (which is about running a
# wayland compositor): mangohud 0.8.4's meson errors out unless x11 or wayland
# is enabled, and the fbdev boards have no xorg.
