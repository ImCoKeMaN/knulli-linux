...
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_ORANGEPI_PC),y)
...
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_H700)$(BR2_PACKAGE_KNULLI_TARGET_A133),y)
LIBRETRO_PARALLEL_N64_EXTRA_ARGS+=WITH_DYNAREC=aarch64
LIBRETRO_PARALLEL_N64_PLATFORM=h5
# unoptimized yet
...
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_LIBRETECH_H5),y)
LIBRETRO_PARALLEL_N64_PLATFORM=h5
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_S922X)$(BR2_PACKAGE_KNULLI_TARGET_A3GEN2),y)
...
ifeq ($(BR2_PACKAGE_HAS_LIBMALI),6)
	LIBRETRO_PARALLEL_N64_GL_LIB=GL_LIB="-L$(STAGING_DIR)/usr/lib -lmali"
endif
