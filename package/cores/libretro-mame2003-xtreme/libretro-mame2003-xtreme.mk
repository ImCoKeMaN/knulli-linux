...
else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_RG35XX),y)
LIBRETRO_MAME2003_XTREME_PLATFORM = unix armv neon hardfloat
LIBRETRO_MAME2003_XTREME_EXTRA_ARGS = HAS_CYCLONE=1 HAS_DRZ80=1

else ifeq ($(BR2_PACKAGE_KNULLI_TARGET_ORANGEPI_PC)$(BR2_PACKAGE_KNULLI_TARGET_CHA)$(BR2_PACKAGE_KNULLI_TARGET_RK3128),y)
LIBRETRO_MAME2003_XTREME_PLATFORM = rpi2
LIBRETRO_MAME2003_XTREME_EXTRA_ARGS = HAS_CYCLONE=1 HAS_DRZ80=1
endif
