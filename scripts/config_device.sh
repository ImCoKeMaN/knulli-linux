...
if [ -f "$CONFIG_FILE" ]; then
    update_line_if_needed "$CONFIG_FILE" 'BR2_GLOBAL_PATCH_DIR=' "BR2_GLOBAL_PATCH_DIR=\"\$(BR2_EXTERNAL_KNULLI_PATH)/board/patches \$(BR2_EXTERNAL_KNULLI_PATH)/board/allwinner/patches \$(BR2_EXTERNAL_KNULLI_PATH)/board/allwinner/h700/patches \$(BR2_EXTERNAL_KNULLI_PATH)/board/allwinner/h700/$REPLACEMENT/patches \""
    update_line_if_needed "$CONFIG_FILE" 'BR2_ROOTFS_OVERLAY=' "BR2_ROOTFS_OVERLAY=\"\$(BR2_EXTERNAL_KNULLI_PATH)/board/fsoverlay \$(BR2_EXTERNAL_KNULLI_PATH)/board/allwinner/h700/fsoverlay \$(BR2_EXTERNAL_KNULLI_PATH)/board/allwinner/h700/$REPLACEMENT/fsoverlay \""
else
