...
cp "${BINARIES_DIR}/rk3326-rg351p-linux.dtb"        "${KNULLI_BINARIES_DIR}/boot/boot/rk3326-rg351p-linux.dtb"        || exit 1
cp "${BINARIES_DIR}/rk3326-odroidgo2-linux.dtb"     "${KNULLI_BINARIES_DIR}/boot/boot/rk3326-odroidgo2-linux.dtb"     || exit 1
cp "${BINARIES_DIR}/rk3326-odroidgo2-linux-v11.dtb" "${KNULLI_BINARIES_DIR}/boot/boot/rk3326-odroidgo2-linux-v11.dtb" || exit 1
cp "${BINARIES_DIR}/rk3326-odroidgo3-linux.dtb"     "${KNULLI_BINARIES_DIR}/boot/boot/rk3326-odroidgo3-linux.dtb"     || exit 1
