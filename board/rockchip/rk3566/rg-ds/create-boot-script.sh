...
cp "${BINARIES_DIR}/kernel-rg-ds/Image"		                "${KNULLI_BINARIES_DIR}/boot/boot/linux"              || exit 1
...
cp "${BOARD_DIR}/rk3566-anbernic-rg-ds.dtb"			"${KNULLI_BINARIES_DIR}/boot/boot/rk3566-anbernic-rg-ds.dtb"   || exit 1
